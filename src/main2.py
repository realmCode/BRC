...
def process_chunk_threaded(lines, thread_workers=4):
    """
...
def main(input_file="testcase.txt", output_file="output.txt", proc_workers=None, chunk_size=100000, thread_workers=4):
    ...
    # Process large chunks in parallel using processes.
